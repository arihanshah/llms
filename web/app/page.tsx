  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center px-6">
      <button
        ...
        className="absolute top-5 right-5 z-10 p-2 text-text-secondary hover:text-accent transition-colors"
      >
        {theme === "dark" ? (
        ...
        <div className="stagger-4 mt-4 rounded-lg border border-border bg-surface/50 overflow-hidden">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 px-4 py-2.5">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <span className={`text-xs w-[4.5rem] transition-colors ${parseInt(maxPagesInput, 10) > MAX_LIMIT ? "text-accent font-medium" : "text-text-tertiary"}`}>
